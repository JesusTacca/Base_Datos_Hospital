			...
			<article id="salida">
				<table>
					...
					<tr>
						...
						<th>Numero de Historial Persona</th>
					...
					<%
						...
						try{
							...
							String insert_value ="SELECT p.DNI,p.NumSeguSoc,a.Num_Historial,p.Telefono,p.Direccion,p.Fech_Nac,p.Nombre,p.Prim_Apellido,p.Seg_Apellido,p.Sexo FROM paciente a inner join persona p on p.DNI=a.DNI;";
							...
							while (rs.next()){
								...
								out.print("<td>"+rs.getObject("Num_Historial")+"</td>");
