...
<body>
	<div id="agrupar">
		...
		<section id="seccion">
			...
			<article id="salida">
				<table>
					<caption>Lista de auxiliadores</caption>
					<tr>
						<th>DNI Persona</th>
					...
					<%
						...
						try{
							...
							String insert_value ="SELECT p.DNI,p.NumSeguSoc,a.Codigo,p.Telefono,p.Direccion,p.Fech_Nac,p.Nombre,p.Prim_Apellido,p.Seg_Apellido,p.Sexo FROM auxiliador a inner join persona p on p.DNI=a.DNI;";
