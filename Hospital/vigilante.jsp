				...
				<table>
					...
					<%
						...
						try{
							...
							String insert_value ="SELECT p.DNI,p.NumSeguSoc,a.Codigo,p.Telefono,p.Direccion,p.Fech_Nac,p.Nombre,p.Prim_Apellido,p.Seg_Apellido,p.Sexo FROM vigilante a inner join persona p on p.DNI=a.DNI;";
