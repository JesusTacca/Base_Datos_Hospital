				...
				<table>
					...
					<%
						...
						try{
							...
							String insert_value ="SELECT a.RUC_Hosp, p.DNI,p.NumSeguSoc,a.Codigo,p.Telefono,p.Direccion,p.Fech_Nac,p.Nombre,p.Prim_Apellido,p.Seg_Apellido,p.Sexo FROM personal a inner join persona p on p.DNI=a.DNI;";
							Statement st=conexion.createStatement();
							ResultSet rs=st.executeQuery(insert_value);
							while (rs.next()){
								out.print("<tr><td>"+rs.getObject("DNI")+"</td>");
								out.print("<td>"+rs.getObject("RUC_Hosp")+"</td>");
